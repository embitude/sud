		...
		struct spi_transfer *t) 
{
	...
	l = mcspi_read_reg(mcspi, OMAP2_MCSPI_CHCONF0); 
	// TODO 2.3: Select Data line 0 from reception & Data line 1 for transmission 
	// TODO 2.4: Set the word len as per word_len
	...
	// TODO 2.8: Update the chconf0 register
	return 0;
}
...
static int my_mcspi_probe(struct platform_device *pdev)
{
	...
	// TODO 3.5 Allocate the memory for omap2_mcspi and assign it to mcspi
	
    platform_set_drvdata(pdev, mcspi);

	// TODO 3.6 Get the base address from platform device
    if (r == NULL) {
        return -ENODEV;
    }
	/*
...
static int my_mcspi_remove(struct platform_device *pdev)
{
	...
	//TODO 3.7 Free up the mcspi data structure
	return 0;
}

//TODO 3.4 Populate the id table with compatible property as per dtb
...
//TODO 3.3 Populate the platform driver structure
...
{
	//TODO 3.1 Register the platform driver
}

static void __exit omap_spi_exit_driver(void)
{
	//TODO 3.2 De-register the platform driver
}
